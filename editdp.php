...
<!--- tambah data -->
			<?php
				...
				if (isset($_GET['KODEP'])) {
				  ...
				  $stid = oci_parse($koneksi,"SELECT * FROM pelanggan WHERE KODEP = '$KODEP'");
				  oci_execute($stid);
			...
			<div class="form-row">
				<input type="hidden" class="form-control" name="KODEP" value="<?= $d['KODEP'] ?>">
				...
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="KONTAK" value="<?= $d['KONTAK'] ?>">
				</div>	
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
